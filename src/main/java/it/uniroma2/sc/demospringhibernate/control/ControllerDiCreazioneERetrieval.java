...
@Service
public class ControllerDiCreazioneERetrieval
        implements IControllerDiCreazioneERetrieval {
    ...
    public Persona creaPersona(@NotNull Persona p){return personaDao.save(p);}

    public List<Persona> leggiPersone() {
